...
/// | 4/25 | Block quotes | Examined 2026-09-11, and the everyday shapes all work — measured: lazy continuation without the marker, continuation with it, a blank quoted line splitting paragraphs, a quote inside a quote, and a fence inside one. All four failures need the parser to count columns *after* the quote marker, which nothing does yet: `>     foo` is four columns past it and so a code block, and `> foo` followed by a four-column line is the same paragraph rather than a list. An edge of the feature rather than a gap in it — worth saying, because the first version of this note called it a gap and would have sent somebody after it ahead of better work. |
