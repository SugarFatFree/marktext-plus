  ...
  List<McpTool> get all => [
    ...
    McpTool(
      ...
      description:
          ...
          'and after opening something large: this editor is meant to stay '
          'light, and that is the number the claim is made of. Read "window" '
          'before set_window moves it, because that is the only way to put it '
