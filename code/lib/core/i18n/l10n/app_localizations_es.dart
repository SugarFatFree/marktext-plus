...
class AppLocalizationsEs extends AppLocalizations {
  ...
  @override
  String get paragraphMoveBlockDown => 'Mover bloque abajo';
  ...
  @override
  String get settingsPreviewFontFamily => 'Fuente de la vista previa';
  ...
  @override
  String get settingsAiEnabled => 'Activar plugins de IA';

  @override
  String get settingsAiProvider => 'Proveedor de IA';

  @override
  String get settingsAiEndpoint => 'Punto final de API';
  ...
  @override
  String get settingsAiAnthropic => 'Proveedor Anthropic';
  ...
  @override
  String get settingsPluginsDiscover => 'Descubrir plugins de la comunidad';

  @override
  String get pluginPermissions => 'Permisos';

  @override
  String get pluginAsksForNothing => 'Este plugin no solicita nada.';

  @override
  String get pluginNoRepository => 'Este plugin no indica su procedencia.';

  @override
  String get pluginNoReleaseNotes => 'Esta versión no incluye notas.';

  @override
  String get pluginOpenRepository => 'Abrir el repositorio';

  @override
  String get pluginSaveSettings => 'Guardar la configuración';

  @override
  String pluginNoSettings(String plugin) {
    return '$plugin no tiene ajustes.';
  }

  @override
  String get pluginSdkOpenFailed => 'No se pudo abrir el SDK de plugins';

  @override
  String get pluginDevelop => 'Desarrollar un plugin';

  @override
  String get pluginNoReleases =>
      'No se encontraron versiones instalables para este tema.';

  @override
  String get settingsAiTestFailed => 'Error al probar la configuración de IA';

  @override
  String get aiSetupDisabled => 'Activa primero la IA en los Ajustes.';

  @override
  String get aiSetupEndpoint =>
      'Introduce primero el punto de acceso de la IA en los Ajustes.';

  @override
  String get aiSetupModel =>
      'Introduce primero el modelo de IA en los Ajustes.';

  @override
  String get aiSetupKey =>
      'Introduce primero la clave de API de la IA en los Ajustes.';

  @override
  String get settingsCopyError => 'Copiar el error';

  @override
  String get settingsPluginsUnreadable => 'Instalado pero ilegible';
  ...
  @override
  String get settingsPluginsEmpty => 'No hay plugins instalados';

  @override
  String get settingsPluginsUnverified =>
      'Comunidad / No verificado. Revisa el código antes de activarlo.';

  @override
  String get settingsAiTest => 'Probar configuración';

  @override
  String get settingsAiEndpointHint =>
      'Introduce solo la raíz del proveedor; no añadas /v1/messages ni /v1/chat/completions.';

  @override
  String get settingsAiTestSuccess =>
      'La prueba de configuración de IA tuvo éxito.';
  ...
  String pluginEdited(String plugin) {
    return '$plugin cambió el documento';
  }
  ...
  String pluginPermissionRefused(
    ...
    return '$plugin no pidió el permiso «$permission» — significa: $meaning';
  }

  @override
  String get pluginCatalogUnreachable =>
      'No se pudo conectar con GitHub. Comprueba la red o un proxy.';

  @override
  String get pluginCatalogRateLimited =>
      'GitHub está limitando las búsquedas desde este equipo. Inténtalo de nuevo en un minuto.';

  @override
  String pluginCatalogRateLimitedIn(int seconds) {
    return 'GitHub está limitando las búsquedas desde este equipo. Inténtalo de nuevo en $seconds segundos.';
  }
}
