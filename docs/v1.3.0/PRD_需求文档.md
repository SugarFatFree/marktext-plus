...
| FEAT-008 | 2026-08-27 | Mermaid 补齐 requirementDiagram / sankey / block / C4 | 中 | 困难 | **已全部完成**（requirementDiagram、sankey-beta 见本版；block-beta、C4 见 v1.4.0 FEAT-004 / FEAT-005） |
...
| 优先级 | 中 |
| 难易度 | 困难 |
| 状态 | **已完成** —— requirementDiagram 见 FEAT-015，sankey-beta 见 FEAT-017，block-beta 与 C4 系列见 v1.4.0 的 FEAT-004 / FEAT-005 |
