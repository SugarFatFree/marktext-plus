...
| **✍️ Réécriture** | Une extension peut réécrire ce que vous avez sélectionné — après vous l’avoir montré. Le résultat arrive avec un bouton Appliquer, et appliquer passe par l’historique de l’éditeur : une annulation le reprend La réponse apparaît à mesure qu’elle s’écrit, pas une fois terminée. |
...
| **Dépendances directes** | 27 | 56 (paquet desktop) | propriétaire |
