...
- **Suporte multilingue**: 12 idiomas incluindo ingles, chines, japones, coreano, alemao, frances, italiano, russo, espanhol, portugues, arabe e portugues brasileiro
...
Este projeto esta licenciado sob a Licenca MIT - consulte o ficheiro [LICENSE](../../code/LICENSE) para mais detalhes.
