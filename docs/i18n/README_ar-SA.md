...
| **🧪 مُختبَر** | 2417 اختبارًا تغطي المحلل والمصدّرات وال providers وبيئات الإضافات وعناصر المحرِّر |
...
| الميزة | الوصف |
|---------|-------------|
| **🔐 الأذونات** | مُعلَنة في البيان، ومعروضة قبل التثبيت، و**مُطبَّقة**. يعرض VS Code وIntelliJ قائمةً ثم يثقان؛ وهنا لا يراجع أحد شيئًا، فالمحرِّر هو الذي يتحقق. والإضافة التي تسأل النموذج بلا `ai.chat` تُمنَع، ويُقال لك إنها حاولت |
