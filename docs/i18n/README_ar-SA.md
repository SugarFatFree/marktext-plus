...
| **🧪 مُختبَر** | 2432 اختبارًا تغطي المحلل والمصدّرات وال providers وبيئات الإضافات وعناصر المحرِّر |
...
| **⚙️ إعداداتها الخاصة** | يرسم المحرِّر صفحة الإعدادات مما أعلنته الإضافة: مفتاح للمفتاح، وحقل مخفيّ للسرّ. الإضافات تعطي بيانات، لا عناصر واجهة |
