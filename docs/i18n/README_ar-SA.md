...
| **🧪 مختبر جيد** | 2025 اختبارًا تغطي المحلل والمصدّرات والـ providers وواجهات المحرر |
...
نزّل أحدث إصدار لمنصتك من [Releases](https://github.com/marktext-plus/marktext-plus/releases).
