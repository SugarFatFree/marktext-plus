...
| **📄 الملفات الكبيرة** | التحليل والتلوين والبحث كلها بمرور واحد، وبميزانيات تسقط الاختبارات إن تجاوزتها. وفوق 128 كيلوبايت يتوقف التلوين — وهو آخر حجم يُفتح في نحو ثانية. والتحرير يبقى كما هو، وتعود الألوان إن صغُر الملف |
...
| **✍️ الكتابة في المستند** | للإضافة أن تعيد صياغة ما حدَّدته — بعد أن تعرضه عليك. ويأتي الناتج ومعه زر «تطبيق»، والتطبيق يمرّ بسجل المحرِّر، فتراجعٌ واحد يعيد كل شيء |
