...
| **`get_state`** | Что открыто: вкладки, режим просмотра, установленные плагины, заполненные области |
| **`control`** | Открыть и закрыть вкладки, сменить режим, записать содержимое, закрыть область |
