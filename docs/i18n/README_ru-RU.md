...
| **🧪 Покрыто тестами** | 2432 тестов на разборщик, экспорт, провайдеры, среды плагинов и виджеты редактора |
...
| **⚙️ Свои настройки** | Редактор рисует страницу по тому, что заявил плагин: переключатель для переключателя, скрытое поле для секрета. Плагины дают данные, а не виджеты |
