...
| **`control`** | 14 действий: открыть, закрыть, сохранить и переключить вкладку, записать содержимое, сменить режим просмотра, закрыть панель, выполнить команду плагина, открыть панель плагина, изменить настройку, открыть закрытую вкладку, переместить окно и изменить его размер — **а также установить плагин или заменить приложение сборкой из CI** |
