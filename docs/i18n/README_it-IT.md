...
| **✍️ Riscrittura** | Un’estensione può riscrivere ciò che hai selezionato — dopo avertelo mostrato. Il risultato arriva con un pulsante Applica, e applicare passa per la cronologia dell’editor: un annulla lo riporta indietro La risposta compare mentre viene scritta, non quando è finita. |
