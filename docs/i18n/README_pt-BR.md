...
| Feature | Description |
|---------|-------------|
| **📝 Três modos de edição** | Código-fonte com destaque de sintaxe, pré-visualização ao vivo e visualização dividida |
| **🎨 8 temas bonitos** | Red Graphite, Shibuya, Pink Blossom, Sky Blue, Dark Graphite, Dieci OLED, Nord, Midnight |
| **🌍 12 idiomas** | Inglês, chinês, japonês, coreano, alemão, francês, italiano, russo, espanhol, português, árabe e português brasileiro |
| **⚡ Resposta rápida** | Parser e renderizador Markdown próprios, sem dependências pesadas |
| **🔍 Buscar e substituir** | Pesquisa completa com suporte a expressões regulares |
| **📂 Árvore de arquivos** | Navegação lateral com suporte a arrastar e soltar pastas |
| **⌨️ Atalhos personalizáveis** | Atalhos de teclado totalmente configuráveis |
| **💾 Salvamento automático** | Configuração persistente em JSON para nunca perder o trabalho |
...
Baixe a versão mais recente para sua plataforma em [Releases](https://github.com/yourusername/marktext-plus/releases).
