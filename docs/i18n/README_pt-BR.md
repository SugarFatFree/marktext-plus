[English](../../README.md) | [简体中文](README_zh-CN.md) | [日本語](README_ja-JP.md) | [한국어](README_ko-KR.md) | [Deutsch](README_de-DE.md) | [Français](README_fr-FR.md) | [Italiano](README_it-IT.md) | [Русский](README_ru-RU.md) | [Español](README_es-ES.md) | [Português](README_pt-PT.md) | [العربية](README_ar-SA.md)
...
> **Aviso**
> As versões macOS irão mostrar o aviso "A Apple não conseguiu verificar se o MarkText Plus está livre de malware..." devido à falta de notarização.
>
> Após arrastar o MarkText Plus para a pasta "Aplicativos", execute os seguintes comandos:
>
> ```bash
